...
(function () {
    ...
    console.log(sayHello("Smarty Pants"));
     ...
     */
    var helloMessage = sayHello("Charles Aggasid");
    ...
    console.log(calculateTip(0.2, 50));
    /**
     * TODO:
    ...
    var totalBillWithTip = parseFloat(
        alert("Please tip $" + calculateTip(tipPercentage, totalBill).toFixed(2))
    );
    ...
    function applyDiscount(origPrice, discountPercentage) {
        var discountAmount = origPrice * discountPercentage;
        return origPrice - discountAmount;
    }

    console.log(applyDiscount(10, 0.2));
})();
